...
contains
      ...
      subroutine update(dt,dx,dy,eps,eta,etan,g,h,hmin,hzero,j,k,u,un,v,vn,wet)
! === Original code from wave2d starts here === ! === Original code from wave2d starts here ===
