...
!      OPERATOR -, INTEGER CONSTANTS AND INTEGER VARIABLES.  SOME OF THE 
!      TESTS USE PARENTHESES TO GROUP ELEMENTS IN AN ARITHMETIC          
!      EXPRESSION.                                                       
!                                                                        
!          THERE ARE TESTS WHERE THE ARITHMETIC EXPRESSION CONTAINS      
!          (1)  INTEGER VAR.= INT. VAR. - INT.VAR.-INT.CON               
!                           = INT. VAR. - INT.CON.-INT.VAR               
!                           = INT. CON. - INT.VAR -INT.VAR.              
!          (2)  SAME FORMS AS (1) BUT WITH PARENTHESES TO GROUP ELEMENTS 
...
!                                                                        
!      TEST 330 THROUGH TEST 347 CONTAIN TWO INTEGER VARIABLES, AN       
!      INTEGER CONSTANT AND OPERATOR - IN AN ARITHMETIC EXPRESSION.  THE 
!      INTEGER VARIABLES CONTAIN POSITIVE AND NEGATIVE VALUES.           
!                                                                        
!      TEST 330 THROUGH TEST 337     IV = IV -IV -IC                     
!                                                                        
 3301 continue                                                          
      ivtnum = 330                                                      
!                                                                        
...
23370 ivfail = ivfail + 1                                               
      ...
      write (i02,80004) ivtnum, ivcomp ,ivcorr                          
!                                                                        
!      TEST 338 THROUGH TEST 343           IV=IV-IC-IV                   
!                                                                        
 3381 continue                                                          
      ivtnum = 338                                                      
!                                                                        
...
23430 ivfail = ivfail + 1                                               
      ...
      write (i02,80004) ivtnum, ivcomp ,ivcorr                          
!                                                                        
!      TEST 344 THROUGH TEST 347      IV=IC-IV-IV                        
!                                                                        
 3441 continue                                                          
      ivtnum = 344                                                      
!                                                                        
...
23470 ivfail = ivfail + 1                                               
      ...
      write (i02,80004) ivtnum, ivcomp ,ivcorr                          
!                                                                        
!      TEST 348 THROUGH TEST 359 CONTAIN TWO INTEGER VARIABLES, AN       
!      INTEGER CONSTANT AND OPERATOR - IN AN ARITHMETIC EXPRESSION.      
!      PARENTHESES ARE USED TO GROUP THE ELEMENTS IN THE ARITHMETIC      
!      EXPRESSION.  THE INTEGER VARIABLES CONTAIN POSITIVE AND NEGATIVE  
!      VALUES.                                                           
!                                                                        
 3481 continue                                                          
      ivtnum = 348                                                      
...
!                                                                        
90007 format (" ",20x,"END OF PROGRAM FM032" )                          
      end program fm032
