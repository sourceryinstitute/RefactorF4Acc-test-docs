...
! *****          USES GENERIC FUNCTIONS AS ARGUMENTS TO          TABLE 5 
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****  S P E C I F I C A T I O N S  SEGMENT 212                        
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
...
! BE** ********************** BBCHED0A **********************************
! *****                                                                  
! *****    HEADER FOR SEGMENT 212                                        
        write(nuvi,21200)                                               
21200 format( " ", /  " YGEN7 - (212) GENERIC FUNCTIONS --" //                  "  AS ARGUMENTS TO OTHER FUNCTIONS" //                            "  ANS REF. - 15.3" )                                   
! BB** ********************** BBCHED0B **********************************
...
! BE** ********************** BBCHED0B **********************************
! *****                                                                  
! T001*  TEST 1                        TEST OF ABS AND MIN WITH INTEGERS 
! *****                                                                  
           ivtnum = 1                                                   
        lvi = 2 - abs( min( -3, -8))                                    
...
20010 ivfail = ivfail + 1                                          
 ...
 0011      continue                                                     
! T002*  TEST 2                      TEST OF MOD AND SIGN WITH INTEGERS  
           ivtnum = 2                                                   
...
20020 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80010) ivtnum, lvi, ivcorr                      
 0021      continue                                                     
! T003*  TEST 3                          TEST OF COS AND SQRT WITH REALS 
           ivtnum = 3                                                   
...
20030 ivfail = ivfail + 1                                          
 ...
 0031      continue                                                     
! T004*  TEST 4                    TEST OF MAX, LOG AND LOG10 WITH REALS 
           ivtnum = 4                                                   
...
20040 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80012) ivtnum, avs, rvcorr                      
 0041      continue                                                     
! T005*  TEST 5                     TEST OF EXP AND MOD WITH DOUBLE PREC 
           ivtnum = 5                                                   
...
20050 ivfail = ivfail + 1                                          
 ...
 0051      continue                                                     
! T006*  TEST 6                          TEST OF SINH, ABS, TAN AND ATAN 
           ivtnum = 6                                                   
...
20060 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0061      continue                                                     
! T007*  TEST 7               TEST OF EXP WITH COMPLEX AND COS WITH REAL 
           ivtnum = 7                                                   
