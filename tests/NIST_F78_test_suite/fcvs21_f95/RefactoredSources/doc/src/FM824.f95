...
! *****    TEST INTRINSIC FUNCTION DATAN, DATAN2                  15.3   
! *****    INTRINSIC FUNCTION DSQRT ASSUMED WORKING              TABLE 5 
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****    S P E C I F I C A T I O N S SEGMENT 196                       
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
...
! BE** ********************** BBCHED0A **********************************
! *****                                                                  
! *****    HEADER FOR SEGMENT 196                                        
        write(nuvi,19600)                                               
19600 format(" ", / "  YDATAN - (196) INTRINSIC FUNCTIONS" //                  "  DATAN, DATAN2 (DOUBLE PRECISION ARCTANGENT)" //                "  ANS REF. - 15.3" )                                    
! BB** ********************** BBCHED0B **********************************
...
! *****                                                                  
        write(nuvi,19601)                                               
19601 format(/ 8x, "TEST OF DATAN" )                                  
! *****                                                                  
! T001*  TEST 1                LARGE ARGUMENT VALUES TO TEST SINGULARITY 
           ivtnum = 1                                                   
        bvd = 500.0d0                                                   
        avd = datan(bvd)                                                
...
20010 ivfail = ivfail + 1                                          
 ...
 0011      continue                                                     
! T002*  TEST 2                LARGE ARGUMENT VALUES TO TEST SINGULARITY 
           ivtnum = 2                                                   
        avd = datan(-1000.0d0)                                          
...
20020 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0021      continue                                                     
! T003*  TEST 3                         AN EXPRESSION PRESENTED TO DATAN 
           ivtnum = 3                                                   
...
20030 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0031      continue                                                     
! T004*  TEST 4               THE FUNCTION DSQRT EVALUATED AND PRESENTED 
! *****                       AS AN ARGUMENT                             
           ivtnum = 4                                                   
        bvd = -dsqrt(3.0d0)                                             
        avd = datan(bvd)                                                
...
! *****                                                                  
        write(nuvi,19608)                                               
19608 format(/ 08x, "TEST OF DATAN2" )                                
! T007*  TEST 7                  TEST (0,POSITIVE) TO TEST DISCONTINUITY 
           ivtnum = 7                                                   
        bvd = 10.0d0 / 10.0d0                                           
        cvd = 0.0d0                                                     
        avd = datan2(cvd, bvd)                                          
...
20070 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0071      continue                                                     
! T008*  TEST 8                  TEST (0,NEGATIVE) TO TEST DISCONTINUITY 
           ivtnum = 8                                                   
        bvd = 0.0d0                                                     
        cvd = -25.0d0 / 2.0d0                                           
        avd = datan2(bvd, cvd)                                          
...
20080 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0081      continue                                                     
! T009*  TEST 9                        AN EXPRESSION PRESENTED TO DATAN2 
           ivtnum = 9                                                   
        bvd = 1.0d0                                                     
        cvd = bvd + bvd                                                 
...
20090 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0091      continue                                                     
! T010*  TEST 10                    ARGUMENTS WHERE (X,Y) X IS NEAR ZERO 
           ivtnum = 10                                                  
        bvd = dasin(0.6d0)                                              
        cvd = dacos(0.8d0)                                              
        avd = datan2(bvd, cvd)                                          
...
20100 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0101      continue                                                     
! T011*  TEST 11                     WHERE ARGUMENT (X,Y) Y IS NEAR ZERO 
           ivtnum = 11                                                  
...
20110 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0111      continue                                                     
! T012*  TEST 12                     WHERE ARGUMENT (X,Y) Y IS NEAR ZERO 
           ivtnum = 12                                                  
        bvd = -2.5d0                                                    
        cvd = 0.0d0                                                     
        avd = datan2(bvd, cvd)                                          
...
20120 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0121      continue                                                     
! T013*  TEST 13                          COMPARISON OF DATAN AND DATAN2 
           ivtnum = 13                                                  
        avd = (datan(dsqrt(3.0d0) / 3.0d0) * 2.0d0) +                       datan2(-dsqrt(3.0d0) / 2.0d0, 1.0d0 / 2.0d0)                  
