...
! *****    UNIT THAT IS CONNECTED FOR SEQUENTIAL, UNFORMATTED ACCESS     
...
!      I05 CONTAINS THE UNIT NUMBER FOR A SEQUENTIAL UNFORMATTED FILE.   
      i05 = 14                                                          
! X050   REPLACED BY FEXEC X-050 CONTROL CARD (SEQ. FILE UNIT NUMBER).   
!      SPECIFYING I05 = NN OVERRIDES THE DEFAULT I05 = 14.               
! *****                                                                  
      nuvi = i02                                                        
      imvi = i05                                                        
      zprog = 'FM915'                                                   
...
! *****                                                                  
        write(nuvi,43100)                                               
43100 format(" ", / " INQU2 - (431) INQUIRE BY UNIT" //                        " SEQUENTIAL UNFORMATTED FILE, CONNECTED BY OPEN" //              " ANS REF. - 12.10.3" )                                  
! BB** ********************** BBCHED0B **********************************
...
! T001*  TEST 1 - FIRST INQUIRE (AFTER OPEN)                             
           ivtnum = 1                                                   
        inquire(unit=imvi, exist=avb, opened=bvb, number=jvi,                     access=b10vk, sequential=c10vk, form=e11vk,                       unformatted=g10vk, err=20014, iostat=kvi)               
! *****                                                                  
        if (kvi  /=  0) goto 20010                                     
...
20016 ivfail = ivfail + 1                                          
           write (nuvi, 20012) kvi,avb,bvb,jvi,b10vk,c10vk,e11vk,                                g10vk                                    
...
! T002*  TEST 2 - SECOND INQUIRE (AFTER WRITE)                           
           ivtnum = 2                                                   
        inquire(unit=imvi, exist=avb, opened=bvb, number=jvi,                     access=b10vk, sequential=c10vk, form=e11vk,                       unformatted=g10vk, err=20024, iostat=kvi)               
! *****                                                                  
        if (kvi  /=  0) goto 20020                                     
...
20026 ivfail = ivfail + 1                                          
           write (nuvi, 20022) kvi,avb,bvb,jvi,b10vk,c10vk,e11vk,                                g10vk                                    
...
! T003*  TEST 3 - THIRD INQUIRE (AFTER READ)                             
           ivtnum = 3                                                   
        inquire(unit=imvi, exist=avb, opened=bvb, number=jvi,                     access=b10vk, sequential=c10vk, form=e11vk,                       unformatted=g10vk, err=20034,iostat=kvi)                
! *****                                                                  
        if (kvi  /=  0) goto 20030                                     
...
20036 ivfail = ivfail + 1                                          
           write (nuvi, 20032) kvi,avb,bvb,jvi,b10vk,c10vk,e11vk,                                g10vk                                    
