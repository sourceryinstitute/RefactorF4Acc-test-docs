...
! *****    TESTS THE USE OF INTEGER, REAL, DOUBLE PRECISION,       15.3  
! *****    AND MIXED MODE EXPRESSIONS CONTAINING REFERENCES TO     15.10 
! *****    THE INTRINSIC FUNCTIONS OF THE FULL LANGUAGE            6.1.4 
! *****                                                                  
! *****  GENERAL COMMENTS                                                
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****    S P E C I F I C A T I O N S  SEGMENT 173                      
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
      ...
      real :: rxbvs
      real :: rxdvs
        double precision :: dxavd
        double precision :: dxbvd
        double precision :: dxdvd
        double precision :: dxevd
        double precision :: dxfvd
        double precision :: dxgvd
...
! *****                                                                  
! *****                                                                  
! *****    HEADER FOR SEGMENT 173 WRITTEN                                
        write (nuvi,17301)                                              
17301 format(" ", //1x, "YDMMX - (173) INTRINSIC FUNCTIONS--" //              16x, "INTEGER, REAL AND D.P." /,                                  16x, "AND MIXED MODE EXPRESSIONS" //                              2x,  "ANS REF. - 15.3, 15.10, 6.1.4" )                    
! ****                                                                   
! BB** ********************** BBCHED0B **********************************
...
! T009*  TEST 9                                                          
        ...
        dxevd = 1.0d0                                                   
        rxbvs = 1.0                                                     
        dxavd = (10 - dmax1(dxbvd, dxdvd)) * (dmin1(dxevd, dxdvd)                 + dble(rxbvs))                                          
...
! T010*  TEST 10                                                         
        ...
        dxfvd = 1.0d0                                                   
        dxgvd = 3.0d0                                                   
        dxavd = (idint(dxbvd) + 1.0) / (7 - dble(rxbvs)) -                        (dint(dxdvd) + 5 + 5.5) * (dsign(dxevd, dxfvd) /                      sngl(dxgvd))                                        
