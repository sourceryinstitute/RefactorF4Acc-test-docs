...
! *****    TEST INQUIRE BY UNIT ON DIRECT, UNFORMATTED FILE      12.10.3 
! *****                                                                  
! *****    THE TESTS IN THE UNIT ARE ONLY PERFORMED ON A                 
! *****    UNIT THAT IS CONNECTED FOR DIRECT, UNFORMATTED ACCESS         
...
! *****    DIRECT ACCESS FILES - SEGMENT DIRAF3 (412).                   
! ***********************************************************************
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! *****                                                                  
!      I12 CONTAINS THE UNIT NUMBER FOR A DIRECT, UNFORMATTED FILE.      
      i12 = 14                                                          
! X120   REPLACED BY FEXEC X-120 CONTROL CARD (DIR. FILE UNIT NUMBER).   
!      SPECIFYING I12 = NN OVERRIDES THE DEFAULT I12 = 14.               
! *****                                                                  
...
! *****                                                                  
        write(nuvi,43300)                                               
43300 format(" ", / " INQU4 - (433) INQUIRE BY UNIT" //                        " DIRECT ACCESS UNFORMATTED FILE" //                              " ANS REF. - 12.10.3" )                                  
! BB** ********************** BBCHED0B **********************************
...
! T001*  TEST 1 - FIRST INQUIRE (AFTER OPEN)                             
           ivtnum = 1                                                   
        inquire(unit=iovi, exist=avb, opened=bvb, number=jvi,                     access=b10vk, direct=d10vk, recl=kvi, nextrec=lvi,                form=e11vk, unformatted=g10vk, err=20014,iostat=ivi)    
! *****                                                                  
        if (ivi  /=  0) goto 20010                                     
...
20012 format (" ",16x,"COMPUTED: " ,"IOSTAT=",i1,", EXIST=",l1,                 " ,OPENED=",l1,", NUMBER=",i4,","/                                " ",26x,"ACCESS=",a10,", DIRECT=",a3,", RECL=",                   i4,","/" ",26x,"NEXTREC=",i4,", FORM=",                           a11,","/" ",26x,"UNFORMATTED=" ,a3)                  
...
! *****    AS THE OTHER SPECIFIERS HAVE BEEN PREVIOUSLY TESTED           
        inquire(unit=iovi, direct=d10vk, recl=kvi, nextrec=lvi,                   err=20024, iostat=ivi)                                  
! *****                                                                  
        if (ivi  /=  0) goto 20020                                     
...
! *****    THIS INQUIRE ONLY TESTS THE DIRECT, RECL, AND NEXTREC         
! *****    AS THE OTHER SPECIFIERS HAVE BEEN PREVIOUSLY TESTED           
        inquire(unit=iovi, direct=d10vk, recl=kvi, nextrec=lvi,                   err=20034, iostat=ivi)                                  
! *****                                                                  
        if (ivi  /=  0) goto 20030                                     
