...
! *****    TEST INTRINSIC FUNCTION CABS (ABSOLUTE VALUE OF        15.3   
! *****    A COMPLEX ARGUMENT)                                  (TABLE 5)
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****    S P E C I F I C A T I O N S  SEGMENT 158                      
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
...
! BE** ********************** BBCHED0A **********************************
! *****                                                                  
! *****    HEADER FOR SEGMENT 158 WRITTEN                                
        write (nuvi,15801)                                              
15801 format (" ", //1x,"YCABS - (158) INTRINSIC FUNCTION--" //16x,            "CABS (ABSOLUTE VALUE)" //2x,                                     "ANS REF. - 15.3" )                                      
! BB** ********************** BBCHED0B **********************************
...
! BE** ********************** BBCHED0B **********************************
! *****                                                                  
! T001*  TEST 1                               COMPLEX VALUE ZERO (0,0)   
           ivtnum = 1                                                   
        rpavs = cabs((0.0, 0.0))                                        
...
20010 ivfail = ivfail + 1                                          
 ...
 0011      continue                                                     
! T002*  TEST 2               COMPLEX VALUE HAVING ONLY REAL COMPONENT   
           ivtnum = 2                                                   
        rpavs = cabs((3.0, 0.0))                                        
...
20020 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0021      continue                                                     
! T003*  TEST 3          COMPLEX VALUE HAVING ONLY IMAGINARY COMPONENT   
           ivtnum = 3                                                   
        rpavs = cabs((0.0, 3.0))                                        
...
20030 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0031      continue                                                     
! T004*  TEST 4                                ARBITRARY COMPLEX VALUE   
           ivtnum = 4                                                   
        rpavs = cabs((3.0, 4.0))                                        
...
20040 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0041      continue                                                     
! T005*  TEST 5        NEGATIVE REAL COMPONENT, NO IMAGINARY COMPONENT   
           ivtnum = 5                                                   
        rpavs = cabs((-3.0, 0.0))                                       
...
20050 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0051      continue                                                     
! T006*  TEST 6        NO REAL COMPONENT, NEGATIVE IMAGINARY COMPONENT   
           ivtnum = 6                                                   
        rpavs = cabs((0.0, -3.0))                                       
...
20060 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0061      continue                                                     
! T007*  TEST 7       ARBITRARY COMPLEX VALUE WITH NEGATIVE COMPONENTS   
           ivtnum = 7                                                   
        rpavs = cabs((-3.0, -4.0))                                      
...
20070 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0071      continue                                                     
! T008*  TEST 8              COMPLEX VALUE ZERO PRECEDED BY MINUS SIGN   
           ivtnum = 8                                                   
        cpavc = (0.0, 0.0)                                              
        rpavs = cabs(-cpavc)                                            
...
20080 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80012) ivtnum, rpavs, rvcorr                     
 0081      continue                                                     
! T009*  TEST 9               COMPLEX EXPRESSION PRESENTED AS ARGUMENT   
           ivtnum = 9                                                   
        cpavc = (3.0, 4.0)                                              
