...
! *****    TEST INTRINSIC FUNCTION DSIN                           15.3   
! *****                                                          TABLE 5 
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! ****                                                                   
! BE** ********************** BBCCOMNT **********************************
! *****    S P E C I F I C A T I O N S SEGMENT 187                       
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
...
! BE** ********************** BBCHED0A **********************************
! *****                                                                  
! *****    HEADER FOR SEGMENT 187                                        
        write(nuvi,18700)                                               
18700 format(" "/" YDSIN - (187) INTRINSIC FUNCTIONS" //                       "  DSIN - (DOUBLE PRECISION SINE)" //                             "  ANS REF. - 15.3" )                                    
! BB** ********************** BBCHED0B **********************************
...
20070 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0071      continue                                                     
! T008*  TEST 8                           AN EXPRESSION SUPPLIED TO DSIN 
           ivtnum = 8                                                   
        bvd = 2000.0d0                                                  
        avd = dsin(bvd / 10.0d2)                                        
...
20090 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0091      continue                                                     
! T010*  TEST 10                A LARGE VALUE TO TEST ARGUMENT REDUCTION 
           ivtnum = 10                                                  
        avd = dsin(100.0d0)                                             
...
20100 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, avd, dvcorr                      
 0101      continue                                                     
! T011*  TEST 11                                      A VERY LARGE VALUE 
           ivtnum = 11                                                  
        avd = dsin(-1000.0d0)                                           
