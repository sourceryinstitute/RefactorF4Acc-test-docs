...
! *****    TEST INQUIRE BY FILE ON SEQUENTIAL, FORMATTED FILES   12.10.3 
! *****                                                                  
! *****    THE TESTS IN THIS UNIT ARE ONLY PERFORMED ON A                
! *****    FILE THAT IS CONNECTED FOR SEQUENTIAL, FORMATTED ACCESS       
...
!       THE CHARACTER STATEMENT FOR FILE NAMES ASSOCIATED WITH X-090     
...
! *****                                                                  
      i09 = 14                                                          
! X090  THIS CARD IS REPLACED BY THE CONTENTS OF CX090                   
!       X-090  I09 = NN WILL OVERRIDE I09 = 14                           
! *****                                                                  
...
! *****  FORMATTED FILE.                                                 
! *****                                                                  
!      CSEQ CONTAINS THE FILE NAME FOR UNIT I09.                         
      cseq = '        SEQFILE'                                          
!                                                                        
...
!      X-090 THAN THE DEFAULT CSEQ = '        SEQFILE'.                  
! *****                                                                  
      nuvi = i02                                                        
      imvi = i09                                                        
      zprog = 'FM919'                                                   
...
! *****                                                                  
        write(nuvi,43800)                                               
43800 format(" ", / " INQF1 - (438) INQUIRE BY FILE" //                        " SEQUENTIAL FORMATTED FILE, CONNECTED BY OPEN" //                " ANS REF. - 12.10.3" )                                  
! BB** ********************** BBCHED0B **********************************
...
! *****                                                                  
! *****    OPEN FILE                                                     
        open(file=cseq, unit=imvi, access='SEQUENTIAL',                        form='FORMATTED', blank='NULL')                            
           ivtnum = 1                                                   
! *****                                                                  
! T001*  TEST 1 -  FIRST INQUIRE (AFTER OPEN)                            
        inquire(file=cseq, exist=avb, opened=bvb, number=jvi,                     access=b10vk, sequential=c10vk, form=e11vk,                       formatted=f10vk, blank=h10vk, err=20014, iostat=ivi)    
        if (ivi  /=  0) goto 20010                                     
...
20016 ivfail = ivfail + 1                                          
           write (nuvi, 20012) ivi,avb,bvb,jvi,b10vk,c10vk,e11vk,                                f10vk,h10vk                              
20012 format (" ",16x,"COMPUTED: " ,"IOSTAT=",i1,", EXIST=",l1,                 " ,OPENED=",l1,", NUMBER=",i4,","/                                " ",26x,"ACCESS=",a10,", SEQUENTIAL=" ,a3,", FORM=",              a9,","/" ",26x,"FORMATTED=" ,a3,", BLANK=",a4)       
           write (nuvi, 20013) imvi                                     
20013 format (" ",16x,"CORRECT:  " ,"IOSTAT=0, EXIST=T, " ,                     "OPENED=T, NUMBER=" ,i4,","/                                      " ",26x,"ACCESS=SEQUENTIAL, SEQUENTIAL=YES, FORM=" ,              "FORMATTED," /" ",26x,"FORMATTED=YES, BLANK=NULL" )  
 0011   continue                                                        
! *****                                                                  
