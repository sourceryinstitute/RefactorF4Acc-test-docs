...
! *****    TEST INTRINSIC FUNCTION DBLE (EXPRESS S.P. ARGUMENT     15.3  
! *****    IN DOUBLE PRECISION FORM )                           (TABLE 5)
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****    S P E C I F I C A T I O N S  SEGMENT 169                      
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
      ...
      real :: rvavs
      real :: rvbvs
        double precision :: dvavd
        double precision :: dvbvd
        double precision :: dvcorr
        double precision :: dvavd1
! *****                                                                  
! BB** ********************** BBCINITA **********************************
...
! *****                                                                  
        write (nuvi,16901)                                              
16901 format(" ",//1x,"YDBLE - (169) INTRINSIC FUNCTION--" //                   16x,"DBLE (TYPE CONVERSION)" // 2x,                               "ANS REF. - 15.3" )                                     
! BB** ********************** BBCHED0B **********************************
...
20010 ivfail = ivfail + 1                                          
 ...
 0011      continue                                                     
! T002*  TEST 2              A D.P. CONSTANT WITH 6 SIGNIFICANT DIGITS   
           ivtnum = 2                                                   
        rvavs = 0.015625                                                
        dvavd = dble(rvavs)                                             
...
20020 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0021      continue                                                     
! T003*  TEST 3                              A NEGATIVE INTEGRAL VALUE   
           ivtnum = 3                                                   
        rvavs = -321.0                                                  
        dvavd = dble(rvavs)                                             
...
20030 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0031      continue                                                     
! T004*  TEST 4     A NEGATIVE D.P. CONSTANT WITH 6 SIGNIFICANT DIGITS   
           ivtnum = 4                                                   
        rvavs = -0.015625                                               
        dvavd = dble(rvavs)                                             
...
20040 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0041      continue                                                     
! T005*  TEST 5                THE VALUE ZERO PRECEDED BY A MINUS SIGN   
           ivtnum = 5                                                   
        rvavs = 0.0                                                     
        dvavd = dble(-rvavs)                                            
...
20050 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0051      continue                                                     
! T006*  TEST 6                              A POSITIVE INTEGRAL VALUE   
           ivtnum = 6                                                   
        rvavs = 321.0                                                   
        dvavd = dble(rvavs)                                             
...
20060 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0061      continue                                                     
! T007*  TEST 7           AN ARITHMETIC EXPRESSION IS USED AS ARGUMENT   
           ivtnum = 7                                                   
        rvavs = 6.25                                                    
        rvbvs = 2.5                                                     
        dvavd = dble(rvbvs ** 2)                                        
...
20070 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dvavd, dvcorr                    
 0071      continue                                                     
! T008*  TEST 8          COMPARE AUTOMATIC TYPE CONVERSION TO EXPLICIT   
           ivtnum = 8                                                   
        rvbvs = 2.5                                                     
        dvbvd = rvbvs ** 3                                              
        dvavd = dble(rvbvs ** 3)                                        
