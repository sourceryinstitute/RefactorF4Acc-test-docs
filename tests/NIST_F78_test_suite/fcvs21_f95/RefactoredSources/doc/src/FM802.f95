...
! *****    TEST INTRINSIC FUNCTION DABS (ABSOLUTE VALUE OF        15.3   
! *****    A DOUBLE PRECISION ARGUMENT)                         (TABLE 5)
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! BE** ********************** BBCCOMNT **********************************
! *****                                                                  
! *****    S P E C I F I C A T I O N S  SEGMENT 157                      
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
      ...
      integer :: nuvi
      integer :: ivtnum
        double precision :: doavd
        double precision :: dobvd
        double precision :: dodvd
        double precision :: doevd
...
! BE** ********************** BBCHED0A **********************************
! *****                                                                  
! *****    HEADER FOR SEGMENT 157 WRITTEN                                
        write (nuvi,15701)                                              
15701 format (" "//1x,"YDABS - (157) INTRINSIC FUNCTION--" //16x,              "DABS (ABSOLUTE VALUE ) " //  2x,                                 "ANS REF. - 15.3" )                                      
! BB** ********************** BBCHED0B **********************************
...
20040 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80031) ivtnum, doavd, dvcorr                     
 0041      continue                                                     
! T005*  TEST 5                                A POSITIVE INTEGRAL VALUE 
           ivtnum = 5                                                   
        dobvd = 7.0d1                                                   
        doavd = dabs(dobvd)                                             
...
20050 ivfail = ivfail + 1                                          
           ...
           write(nuvi, 80031) ivtnum, doavd, dvcorr                     
 0051      continue                                                     
! T006*  TEST 6              ARITHMETIC EXPRESSION PRESENTED TO FUNCTION 
           ivtnum = 6                                                   
        dodvd = 2.625d0                                                 
        doevd = 3.0d0                                                   
