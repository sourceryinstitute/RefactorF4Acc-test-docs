...
!            (1)  INTEGER CONSTANT-INTEGER CONSTANT-INTEGER VARIABLE     
...
!            (3)  INTEGER VARIABLE - INTEGER VARIABLE                    
!                                                                        
!       REFERENCES                                                       
...
!      TEST SECTION                                                      
!                                                                        
!      TEST 300 THROUGH TEST 309 CONTAIN 2 INTEGER CONSTANTS, AN INTEGER 
!      VARIABLE AND OPERATOR - IN AN ARITHMETIC EXPRESSION.              
!                                                                        
 3001 continue                                                          
      ivtnum = 300                                                      
!                                                                        
...
23090 ivfail = ivfail + 1                                               
      ...
      write (i02,80004) ivtnum, ivcomp ,ivcorr                          
!                                                                        
!      TEST 310 THROUGH TEST 319 CONTAIN 2 INTEGER CONSTANTS, AN INTEGER 
!      VARIABLE AND OPERATOR - IN AN ARITHMETIC EXPRESSION.  PARENTHESES 
!      ARE USED TO GROUP ELEMENTS IN THE ARITHMETIC EXPRESSION.          
!                                                                        
 3101 continue                                                          
      ivtnum = 310                                                      
!                                                                        
...
23190 ivfail = ivfail + 1                                               
      ...
      write (i02,80004) ivtnum, ivcomp ,ivcorr                          
!                                                                        
!      TEST 320 THROUGH TEST 329 CONTAIN 2 INTEGER VARIABLES AND         
!      OPERATOR - IN AN ARITHMETIC EXPRESSION.  THE INTEGER VARIABLES    
...
!                                                                        
90007 format (" ",20x,"END OF PROGRAM FM031" )                          
      end program fm031
