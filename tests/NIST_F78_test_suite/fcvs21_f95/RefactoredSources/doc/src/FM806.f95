...
! *****    DMAX1 -- CHOOSING LARGEST VALUE                      (TABLE 5)
! *****                                                                  
! BB** ********************** BBCCOMNT **********************************
! ****                                                                   
...
! ****                                                                   
! BE** ********************** BBCCOMNT **********************************
! *****    S P E C I F I C A T I O N S  SEGMENT 166                      
      integer :: ivpass
      integer :: ivfail
      integer :: ivdele
      integer :: ivinsp
...
! *****                                                                  
        write (nuvi,16601)                                              
16601 format (" ", // 1x,"YDMAX1 - (166) INTRINSIC FUNCTION-- " //17x,          "DMAX1  (CHOOSING LARGEST VALUE)" //2x,                           "ANS REF. - 15.3" )                                     
! BB** ********************** BBCHED0B **********************************
...
20040 ivfail = ivfail + 1                                          
           ...
           write (nuvi, 80031) ivtnum, dtavd, dvcorr                    
 0041      continue                                                     
! T005*  TEST 5                             ONE VALUE ZERO, ONE NEGATIVE 
           ivtnum = 5                                                   
        dtbvd = -5.625d0                                                
        dtdvd = 0.0d0                                                   
        dtavd = dmax1(dtbvd, dtdvd)                                     
